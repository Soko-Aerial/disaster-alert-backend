    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "example": "Ghana",
                        "description": "Filter by country name or country code.",
                        "name": "country",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "example": 200,
                        "description": "Maximum number of alerts to return. Default is 200, maximum is 500.",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/admin/alerts/active": {
            "get": {
                ...
                "description": "Returns currently active alerts for the admin dashboard.\nSuper admin can see all active alerts. Organisation privilege codes only see alerts inside their permitted scope.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/alerts/global": {
            "get": {
                ...
                "description": "Fetches active global alerts for the admin dashboard.\nIf country is supplied, alerts from that country are excluded. If country is omitted, all active scoped alerts are returned.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "Ghana",
                        "description": "Optional country name or country code to exclude from global view.",
                        "name": "country",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "Ghana",
                        "description": "Country name or country code used to filter local alerts.",
                        "name": "country",
                        "in": "query",
                        "required": true
                    },
        ...
        "/admin/alerts/{id}/status": {
            "put": {
                ...
                "description": "Updates only the status of an alert from the admin dashboard.\nThis does not fully edit the alert content. It only changes status such as draft, active, resolved, expired, or cancelled.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
